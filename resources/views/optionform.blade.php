...
<div id="contents">
<!-- パン屑リスト -->
<p class="topic-path"><a href="/">Home</a> &gt; <a href="/place">Place</a> &gt; <a href="/place/{{ $place->id }}">{{ $place->name }}</a> &gt; Option</p>
...
<form action="/option/store/{{ $id }}" method="post">
    @csrf
    <p><input class="inputbox" type="text" name="name" placeholder="サービス名">
    <input class="inputbox" type="number" step="1" name="value" placeholder="値段"></p>
    <p><input class="btn btn--blue btn--radius" type="submit" value="新規登録"></p>
</form>
...
<p class="clfloat"></p>
<div class="float">
    <form action="/option/update/{{ $option->id }}" method="get">
        @csrf
        <input class="btn btn--blue btn--radius" type="submit" value="更新"> 
    </form>
</div>
<div class="float">
